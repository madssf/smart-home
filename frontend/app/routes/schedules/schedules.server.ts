...
export async function createSchedule(schedule: NewRequest<Schedule>): Promise<void> {
    return await createRequest<NewRequest<Schedule>>(apiRoutes.schedules, schedule);
}
